function fetchData() {
	fetch('https://api.statcord.com/v3/884467910494535741').then(response => {
		...
		document.querySelector('Mais de 50').innerHTML = `<h4>${data.data[0].servers}`
		console.log(data.data[0].users);
		document.querySelector('Mais de 3000').innerHTML = `<h4>${data.data[0].users}`
        console.log(data.data[0].users);
		document.querySelector('Mais de 10000').innerHTML = `<h4>${data.data[0].commands}`
